/// This file shamelessly stolen from https://vsxtra.svn.codeplex.com/svn/VSXTra/Runtime/VSXtra.ProjectSystem/ProjectBase/IDEBuildLogger.cs
...
namespace VSXtra.ProjectSystem
{
    ...
    internal sealed class IDEBuildLogger : Logger
    {
        ...
        private string errorString = "warning";
        private string warningString = "error";
